...
Quando gli agenti di replica `Dispatcher Flush` richiedono che Dispatcher invalidi i file memorizzati nella cache, il percorso del contenuto nell’archivio deve essere risolto nel contenuto della cache.
